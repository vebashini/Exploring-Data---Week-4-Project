...
## Sum the total emissions for each year in the dataset
sumPerYear <- aggregate(Emissions ~ year, NEI, FUN=sum)

## Have emissions decreased? You can see from the graph, that it has overall
png(filename = "plot1.png", width = 480, height = 480)
barplot(sumPerYear$Emissions, names.arg=sumPerYear$year, col = "lightblue",
        xlab = "Year", ylab = "Total PM2.5 Emissions",main = "Total PM2.5 emissions (1999 - 2008)")
dev.off()


## Line plot showing the same
# png(filename = "plot1b.png", width = 480, height = 480)
# plot(sumPerYear, type = "l", col = "maroon3",
